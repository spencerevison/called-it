...
2026-07-02T19:53:00Z | T05 | gates: pass | (pending commit) | supabase init (config.toml + supabase/.gitignore); migration 20260702000001_enums_profiles.sql — all DATA_MODEL enums + profiles; verified via supabase start + db reset (docker) applies cleanly to a fresh local db.
